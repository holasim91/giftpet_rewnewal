...
const DUMMY_PRODUCTS: Product[] = [
  ...
  { id: '2', name: '뉴트리베이스 프로바이오틱스 60캡슐', price: 38000, imageUrl: '/images/placeholder.svg', badges: ['BEST'], category: '소화 영양제' },
  { id: '3', name: '오메가3 피시오일 강아지용 120ml', price: 27000, imageUrl: '/images/placeholder.svg', badges: [], category: '피부 영양제' },
  { id: '4', name: '시니어 케어 플러스 관절·눈 60정', price: 45000, imageUrl: '/images/placeholder.svg', badges: ['NEW'], category: '시니어 영양제' },
];
